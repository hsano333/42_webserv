...
FILESYSTEMSRC 		:= normal_file.cpp directory_file.cpp error_file.cpp opened_socket_file.cpp normal_reader.cpp socket_reader.cpp normal_writer.cpp socket_writer.cpp stream_reader.cpp stream_writer.cpp cgi_file.cpp object_file.cpp
